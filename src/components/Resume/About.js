    ...
    >
      <div className="w-100">
        ...
        <div className="subheading mb-5">
          ...
          <a href="mailto:mail@intanadela.my.id" className="text-lowercase">
            mail@intanadela.my.id
          </a>
        </div>
        <p className="lead mb-5">
          I’m a fresh graduate from Glints Academy. Graduate as a Full-Stack
          JavaScript Developer, I’m now has skills in HTML, CSS, ReactJS, etc. I
          enjoyed the challenges and do not close my self to new things. Have a
          sense of responsibility, honest, good teamwork and ability to work
          under pressure.
        </p>
        <div className="social-icons">
          <OverlayTrigger
            placement="top"
            overlay={<Tooltip>Glints Profile</Tooltip>}
          >
            <a
